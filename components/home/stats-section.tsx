...
export default function StatsSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-ninja-cream via-ninja-peach to-ninja-gold">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-ninja-gray opacity-80 max-w-3xl mx-auto">
            Join thousands of young writers who are already sharing their
            amazing stories!
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {statItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-16 h-16 bg-${item.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
