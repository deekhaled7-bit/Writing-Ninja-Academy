...
export default function QuizzesInDashboard() {
  ...
  const [showSubmissionDetailsModal, setShowSubmissionDetailsModal] =
    useState(false);
  ...
  return (
    <div className="bg-ninja-cream p-4">
      ...
      <Dialog
        ...
        onOpenChange={setShowSubmissionDetailsModal}
      >
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedSubmission &&
                `Student: ${selectedSubmission.student?.firstName} ${
                  selectedSubmission.student?.lastName
                } • Score: ${selectedSubmission.percentageScore.toFixed(
                  1
                )}% • Completed: ${new Date(
