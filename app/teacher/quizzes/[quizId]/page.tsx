  ...
  return (
    <div className="bg-ninja-cream p-4">
      ...
      <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSelectChange("storyId", value)}
                  >
                    <SelectTrigger>
        ...
        <h2 className="text-xl font-semibold text-ninja-black mb-4">Questions</h2>
        
        {quizData.questions.map((question, questionIndex) => (
          <Card key={questionIndex} className="bg-white shadow-sm mb-6">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-lg font-medium text-ninja-black">Question {questionIndex + 1}</h3>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
